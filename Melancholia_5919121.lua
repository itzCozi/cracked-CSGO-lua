...
png:texture(render.load_image(network.get("https://pbs.twimg.com/media/F5s7Df-a0AATHjK?format=jpg&name=900x900"), vector(250, 280)), vector(250, 280), color(255, 255, 255, 255), 'f')
...
damage_indicator = function()
    ...
    local cur_dmg = ui.find("Aimbot", "Ragebot", "Selection", "Global", "Min. Damage"):get()
